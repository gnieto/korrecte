...
pub trait Lint {
    ...
    fn object(&self, object: &KubeObjectType) -> Vec<crate::reporting::Finding> {
        match object {
			...
			&KubeObjectType::V1beta1PodDisruptionBudget(ref o) => self.v1beta1_pod_disruption_budget(o),
			&KubeObjectType::V1HorizontalPodAutoscaler(ref o) => self.v1_horizontal_pod_autoscaler(o),
        _ => Vec::new(),
        }
    }
